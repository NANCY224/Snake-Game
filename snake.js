  ...
  function init()
	{
	  ...
	  W = H = canvas.width = canvas.height = 486;
	  ...
	  snake = {
        ...
        {   
		   ...
		   {
		   	 this.cells.pop(); //remove the last cell from the array of snake
		   }
           ...
           {
           	  nextX = headX + 1;          //Added 1 since have to add the element in front of the headX/after the headX
           	  nextY = headY;
           }
	...
	function draw()
	{
        ...
        pen.drawImage(trophy,20,15,cs,cs);
        pen.fillStyle = "blue";
